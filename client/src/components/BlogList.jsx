...
const BlogList = () => {
    const [menu, setMenu] = useState('All') // ✅ lowercase
            ...
            <div className='flex justify-center gap-4 sm:gap-8 my-10 relative flex-wrap'>
                {blogCategories.map((item) => (
                    <button
                        ...
                        className={`relative cursor-pointer text-gray-500 font-medium transition-all duration-300 ${menu === item && 'text-white px-4 pt-0.5'
                            }`}
                    >
                        {item}
